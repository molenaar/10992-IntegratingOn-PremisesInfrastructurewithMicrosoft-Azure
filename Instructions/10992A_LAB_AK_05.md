...
4.   In the **Deployment planning** blade, under **Have you completed deployment planning?**, select: **I will do it later**, and click **OK**.
...
1.   On  **MIA-CL1**, in the Azure portal, in the  **Internet Explorer** window, in the **Replication policy** blade, click **+Create and Associate**.
...
4.   Back in the  **Prepare infrastructure** blade, click **OK**. This will take you back to the  **Site Recovery** blade.
...
3.   In the  **Replicated items** blade, click the ellipsis to the right of the entry representing the guest virtual machine on your lab virtual machine, and then click **Disable Replication** in the drop-down menu.
4.   In the  **Disable Replication** blade, select **Disable replication and remove (Recommended)** in the **Remove replicated item** drop-down list, and then click **OK**. Wait for the operation to complete. This should take less than a minute.
5.   Scroll back to the  **Settings** blade.
6.   In the  **MANAGE** section of the **Settings** blade, click **Site Recovery Infrastructure**. 
7.   In the  **AdatumASRVault - Site Recovery Infrastructure** blade, click **Hyper-V Hosts**. 
...
11.   In the Hub vertical menu on the left, click **Dashboard**. Under **All resources**, click **AdatumASRVault**.
12.   In the **AdatumASRVault Recovery Services vault** blade, click  **Delete**.
...
16.   In the  **AdatumASRRG** blade, click **Delete resource group**.
