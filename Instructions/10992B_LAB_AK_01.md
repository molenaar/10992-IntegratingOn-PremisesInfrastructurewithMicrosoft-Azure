...
6.   On the **Basics** tab, specify the following settings, and then click **Next: Disks >**:
  ...
  -   Public inbound ports: select **Allow selected ports**, then click the drop-down box and choose **RDP (3389)** 
...
8.   On the **Networking** tab, specify the following settings, and then click **Next: Management >**:
  ...
  -   NIC network security group: accept the default values, which will create a new Basic network security group allowing access via RDP *(The setting from the Basics tab.)*
  -   Accelerated networking: **Off**
  -   Load balancing: **No**
  
9.   On the **Management** tab, specify the following settings, and then click **Next: Advanced >**:
...
10.  On the **Advanced** tab, specify the following settings, and then click **Review + create**:

  -   Extensions: **No extensions**
  -   Coud init: *(Only applies to Linux VMs)*
