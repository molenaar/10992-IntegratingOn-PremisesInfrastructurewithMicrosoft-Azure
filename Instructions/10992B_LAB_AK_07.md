...
3.   At the **Administrator: Windows PowerShell** prompt, type in the following command, and then press Enter (replace `<workspace_name>` with the name of the Log Analytics workspace you created earlier in this lab):
```
...
```
4.   On MIA-CL1, in the Azure portal, in the hub menu, click **All resources** and then click on the Log Analytics workspace you created in the previous exercise.
5.   On the Log Analytics workspace blade, under **Settings**, click: **Advanced settings**.
6.   Ensure that **Connected Sources > Windows Servers >** has been selected and click **Download Window Agent (64-bit)**.
7.   When prompted save **MMASetup-AMD64.exe**, then click **Run**. This will start the **Microsoft Monitoring Agent Setup** wizard. 
8.   On the **Welcome to the Microsoft Monitoring Agent Setup Wizard** page, click **Next**.
9.   On the **IMPORTANT NOTICE** page, click **I Agree**.
10.   On the **Destination Folder** page, click **Next**.
11.   On the **Agent Setup Options** page, select the **Connect the agent to Azure Log Analytics (OMS)** checkbox, and then click **Next**.
12.   Once you reach the **Azure Log Analytics** page, switch to the Internet Explorer window showing the **Advanced settings** blade of the Log Analytics workspace, and then click the copy icon next to the **WORKSPACE ID** entry.
13.   If prompted whether to allow the webpage to access your Clipboard, click **Allow access**.
14.   Switch back to the **Microsoft Monitoring Agent Setup** wizard, place the cursor in the **Workspace ID** text box, and press the **Ctrl+V** key combination to paste the content of Clipboard.
15.   Switch to the Internet Explorer window showing the **Advanced settings** blade of the Log Analytics workspace, and then click the copy icon next to the **PRIMARY KEY** entry.
16.   Switch back to the **Microsoft Monitoring Agent Setup** wizard, place the cursor in the **Workspace Key** text box, and press the **Ctrl+V** key combination to paste the content of Clipboard.
17.   On the same **Azure Log Analytics** page of the wizard, ensure that the entry corresponding to the Azure cloud hosting your subscription (**Azure Commercial** or **Azure US Government**) is selected in the the **Azure Cloud** drop down list.
18.   Click **Next**.
19.   On the **Ready to Install** page of the **Microsoft Monitoring Agent Setup** wizard, click **Install**.
20.   On the **Microsoft Monitoring Agent configuration completed successfully** page, click **Finish**.
...
9.   On MIA-CL1, switch to the **Administrator: Windows PowerShell** window.
