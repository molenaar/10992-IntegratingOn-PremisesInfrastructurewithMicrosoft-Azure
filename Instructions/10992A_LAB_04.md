...
1.   On  **MIA-CL1**, open  **File Explorer**, and browse to the **Documents** folder.
2.   Notice that the folder contains the restored file **hosts**.
3.   Open this file and the  **C:\\Windows\\System32\\Drivers\\etc\\hosts** file in Notepad and verify that their content is identical.
